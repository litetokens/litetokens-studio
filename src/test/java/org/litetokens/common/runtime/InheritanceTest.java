...
public class InheritanceTest {
  ...
  public void inheritanceTest()
    ...
    byte[] contractAddress = LVMTestUtils.deployContractWholeProcessReturnContractAddress(
    ...
    byte[] triggerData1 = LVMTestUtils.parseABI("getName()","");
    runtime = LVMTestUtils.triggerContractWholeProcessReturnContractAddress(callerAddress,contractAddress,triggerData1,
    ...
    byte[] triggerData2 = LVMTestUtils.parseABI("getNumber()","");
    runtime = LVMTestUtils.triggerContractWholeProcessReturnContractAddress(callerAddress,contractAddress,triggerData2,
        0,1000000,deposit,null);
    ...
    byte[] triggerData3 = LVMTestUtils.parseABI("getId()","");
    runtime = LVMTestUtils.triggerContractWholeProcessReturnContractAddress(callerAddress,contractAddress,triggerData3,
        0,1000000,deposit,null);
