...
public class InternalTransactionComplexTest {
   ...
   *
   * // this is to test wither the LVM is returning vars from one contract calling another //
  ...
  public void internalTransactionAsInstanceTest()
    ...
    /* =================================== CALL makeTheCall =================================== */
    byte[] triggerData1 = LVMTestUtils.parseABI("makeTheCall()", "");
    runtime = LVMTestUtils
    ...
    byte[] triggerData2 = LVMTestUtils.parseABI("testCallbackReturns_()", "");
    runtime = LVMTestUtils
        .triggerContractWholeProcessReturnContractAddress(Hex.decode(OWNER_ADDRESS),
