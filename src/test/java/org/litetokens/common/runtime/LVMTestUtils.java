...
public class LVMTestUtils {
  ...
  /**
   * use given input Transaction,deposit,block and execute LVM  (for both Deploy and Trigger
   * contracts)
   */
  ...
  public static LVMTestResult deployContractAndReturnLVMTestResult(String contractName,
      byte[] callerAddress,
      String ABI, String code, long value, long feeLimit, long consumeUserResourcePercent,
    ...
    return processTransactionAndReturnLVMTestResult(xlt, dbManager, blockCap)
        .setContractAddress(Wallet.generateContractAddress(xlt));
  }

  public static LVMTestResult triggerContractAndReturnLVMTestResult(byte[] callerAddress,
  ...
  public static LVMTestResult processTransactionAndReturnLVMTestResult(Transaction xlt,
    ...
    return new LVMTestResult(runtime, trace.getReceipt(), null);
  }
