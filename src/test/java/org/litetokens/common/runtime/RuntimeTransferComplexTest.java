...
public class RuntimeTransferComplexTest {
  ...
  public void TransferXltToContractAccountWhenDeployAContract()
    ...
    Transaction xlt = LVMTestUtils.generateDeploySmartContractAndGetTransaction(
    ...
    runtime = LVMTestUtils.processTransactionAndReturnRuntime(xlt, deposit, null);
  ...
  public void TransferXltToContractAccountWhenTriggerAContract()
    ...
    byte[] contractAddress = LVMTestUtils
    ...
    byte[] triggerData = LVMTestUtils.parseABI(selectorStr, params);

    long triggerCallValue = 100;

    Transaction transaction = LVMTestUtils
        .generateTriggerSmartContractAndGetTransaction(address, contractAddress, triggerData,
            triggerCallValue, feeLimit);
    runtime = LVMTestUtils.processTransactionAndReturnRuntime(transaction, deposit, null);
    Assert.assertNull(runtime.getRuntimeError());
  ...
  public void TransferCallValueTestWhenUsingCallAndCreate()
    ...
    byte[] triggerData1 = LVMTestUtils.parseABI(selectorStr1, params1);

    Transaction transaction1 = LVMTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData1, triggerCallValue, feeLimit);
    runtime = LVMTestUtils.processTransactionAndReturnRuntime(transaction1, deposit, null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    byte[] triggerData2 = LVMTestUtils.parseABI(selectorStr2, params2);

    Transaction transaction2 = LVMTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData2, triggerCallValue, feeLimit);
    runtime = LVMTestUtils.processTransactionAndReturnRuntime(transaction2, deposit, null);
    ...
    byte[] triggerData3 = LVMTestUtils.parseABI(selectorStr3, params3);

    Transaction transaction3 = LVMTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData3, triggerCallValue, feeLimit);
    runtime = LVMTestUtils.processTransactionAndReturnRuntime(transaction3, deposit, null);
    ...
    byte[] triggerData4 = LVMTestUtils.parseABI(selectorStr4, params4);

    Transaction transaction4 = LVMTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData4, triggerCallValue, feeLimit);
    runtime = LVMTestUtils.processTransactionAndReturnRuntime(transaction4, deposit, null);
    ...
    byte[] triggerData5 = LVMTestUtils.parseABI(selectorStr5, params5);

    Transaction transaction5 = LVMTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData5, triggerCallValue, feeLimit);
    runtime = LVMTestUtils.processTransactionAndReturnRuntime(transaction5, deposit, null);
    ...
    byte[] triggerData6 = LVMTestUtils.parseABI(selectorStr6, params6);

    Transaction transaction6 = LVMTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData6, triggerCallValue, feeLimit);
    runtime = LVMTestUtils.processTransactionAndReturnRuntime(transaction6, deposit, null);
