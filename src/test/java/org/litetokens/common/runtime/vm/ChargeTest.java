...
public class ChargeTest {
  ...
  public void testOverflow()
    ...
    /* ====================================================================== */
    byte[] triggerData = LVMTestUtils.parseABI("testOverflow()", "");
    result = LVMTestUtils
  ...
  public void testNegative()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testNegative()", "");
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
    ...
    triggerData = LVMTestUtils.parseABI("testNegative()", "");
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
  ...
  public void testCallDepth()
    ...
    // byte[] triggerData = LVMTestUtils.parseABI("CallstackExploit(int)", params);
    byte[] triggerData = LVMTestUtils.parseABI("Call(int256)", params);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, value, feeLimit, dbManager, null);
  ...
  public void testCallDepthAndWidth()
    ...
    // byte[] triggerData = LVMTestUtils.parseABI("CallstackExploit(int)", params);
    byte[] triggerData = LVMTestUtils.parseABI("Call(uint256)", params);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, value, feeLimit, dbManager, null);
  ...
  public void testCreateDepthAndWidth()
    ...
    // byte[] triggerData = LVMTestUtils.parseABI("CallstackExploit(int)", params);
    byte[] triggerData = LVMTestUtils.parseABI("testCreate(uint256)", params);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, value, feeLimit, dbManager, null);
