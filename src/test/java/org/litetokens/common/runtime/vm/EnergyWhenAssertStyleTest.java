...
import org.litetokens.common.runtime.LVMTestResult;
...
public class EnergyWhenAssertStyleTest {
  ...
  public void outOfIndexTest()
    ...
    LVMTestResult result = LVMTestUtils
        .deployContractAndReturnLVMTestResult(contractName, address, ABI, code,
            value,
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testOutOfIndex()", null);
    result = LVMTestUtils
  ...
  public void bytesNTest()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testbytesN()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void divZeroTest()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testDivZero()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void shiftByNegativeTest()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testShiftByNegative()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void enumTypeTest()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testEnumType()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void functionPointerTest()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testFunctionPointer()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void assertTest()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testAssert()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void systemPrecompileTest()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("voteForSingleWitness(address,uint256)", params);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void outOfMemTest()
    ...
    byte[] triggerData = LVMTestUtils.parseABI("testMem(uint256)", params);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
