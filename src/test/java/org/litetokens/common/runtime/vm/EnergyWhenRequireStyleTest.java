...
public class EnergyWhenRequireStyleTest {
  ...
  public void throwTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = LVMTestUtils.parseABI("testThrow()", null);
    result = LVMTestUtils
  ...
  public void requireTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = LVMTestUtils.parseABI("testRequire()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void thisFunctionViaMessageCallTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = LVMTestUtils.parseABI("testThisFunctionViaMessageCall()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void thatFunctionViaMessageCallTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = LVMTestUtils.parseABI("testThatFunctionViaMessageCall()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void newContractTest1()
    ...
    /* ====================================================================== */
    byte[] triggerData = LVMTestUtils.parseABI("testNewContract()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void receiveXltWithoutPayableTest()
    ...
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - (expectEnergyUsageTotal + expectEnergyUsageTotal2) * 100);
    /* ====================================================================== */
    byte[] triggerData = LVMTestUtils.parseABI("testFallback()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
  ...
  public void revertTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = LVMTestUtils.parseABI("testRevert()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
