...
public class EnergyWhenSendAndTransferTest {
  ...
  public void callValueTest()
    ...
    LVMTestResult result = deployCallValueTestContract(value, feeLimit,
    ...
    /* =================================== CALL simpleCall() =================================== */
    byte[] triggerData = LVMTestUtils.parseABI("simpleCall()", null);
    result = LVMTestUtils
    ...
    /* =================================== CALL complexCall() =================================== */
    triggerData = LVMTestUtils.parseABI("complexCall()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void sendTest()
    ...
    long consumeUserResourcePercent = 100;
    byte[] address = Hex.decode(OWNER_ADDRESS);
    LVMTestResult result = deploySendAndTransferTestContract(value, feeLimit,
        consumeUserResourcePercent);
    ...
    /* =================================== CALL doSend() =================================== */
    byte[] triggerData = LVMTestUtils.parseABI("doSend()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public void transferTest()
    ...
    /* =================================== CALL doSend() =================================== */
    byte[] triggerData = LVMTestUtils.parseABI("doTransfer()", null);
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS),
            contractAddress, triggerData, 0, feeLimit, dbManager, null);
  ...
  public LVMTestResult deployCallValueTestContract(long value, long feeLimit,
  ...
  public LVMTestResult deploySendAndTransferTestContract(long value, long feeLimit,
      long consumeUserResourcePercent)
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException, VMIllegalException {
