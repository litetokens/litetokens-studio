...
public class EnergyWhenTimeoutStyleTest {
  ...
  public void endlessLoopTest()
    ...
    LVMTestResult result = deployEndlessLoopContract(value, feeLimit,
    ...
    byte[] triggerData = LVMTestUtils.parseABI("setVote(uint256)", params);
    boolean haveException = false;
    result = LVMTestUtils
        .triggerContractAndReturnLVMTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
  ...
  public LVMTestResult deployEndlessLoopContract(long value, long feeLimit,
