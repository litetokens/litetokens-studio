...
public class AccountVoteWitnessTest {
  ...
  private List<AccountCapsule> getAccountList() {
    ...
    final AccountCapsule accountLitetokens =
        new AccountCapsule(
            ByteString.copyFrom("00000000001".getBytes()),
            ByteString.copyFromUtf8("Litetokens"),
            AccountType.Normal);
    ...
    final AccountCapsule accountVivider =
        new AccountCapsule(
            ...
            AccountType.Normal);
    // accountLitetokens addVotes
    accountLitetokens.addVotes(accountMarcus.getAddress(), 100);
    accountLitetokens.addVotes(accountOlivier.getAddress(), 100);
    accountLitetokens.addVotes(accountSasaXie.getAddress(), 100);
    accountLitetokens.addVotes(accountVivider.getAddress(), 100);

    // accountMarcus addVotes
    accountMarcus.addVotes(accountLitetokens.getAddress(), 100);
    ...
    accountOlivier.addVotes(accountLitetokens.getAddress(), 100);
    ...
    accountCapsuleList.add(accountLitetokens);
  ...
  private List<WitnessCapsule> getWitnessList() {
    ...
    final WitnessCapsule witnessLitetokens =
    ...
    witnessCapsuleList.add(witnessLitetokens);
